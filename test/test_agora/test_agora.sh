...
for i in `seq 1 $num_iters`; do
  # Everything in the braces below gets redirected to $out_file
  {
    ...
    sleep 1; ./build/sender --num_threads 1 --core_offset 5 --conf_file ${input_filepath}/tddconfig-correctness-test-ul.json
    wait
    ...
    sleep 1; ./build/sender --num_threads 1 --core_offset 5 --conf_file ${input_filepath}/tddconfig-correctness-test-dl.json
    echo -e "-------------------------------------------------------\n\n\n"
    wait
    ...
    sleep 1; ./build/sender --num_threads 1 --core_offset 5 --conf_file ${input_filepath}/tddconfig-correctness-test-both.json
    echo -e "-------------------------------------------------------\n\n\n"
    wait
  } >> $out_file
